...
if [[ "$SHELL" =~ "bash" ]] && [[ "$is_unix" -eq 1 ]]; then
    ...
    PS1='\[\e[32;1m\]\u@$(hostname):\e[36;1m $tm\e[34;1m $ut$cpumsg $du \[\e[36;1m\]\w\[\e[32;1m\]\[ \e[36;1m>\e[35m$jobmsg\e[31;1m$errmsg\e[0m\]\n\$ '
    if [[ "$PLATFORM" == "PI" ]]; then
...
export PATH=$HOME/opt/node-v18.17.1-linux-x64/bin:$PATH
