...
#define ID_TRACKBAR     20002

const int PANEL_H   = 80;
const int BUTTON_W  = 70;
const int BUTTON_H  = 21;
const int BUTTON_BDR_DOWN       = 15;
const int TRACKBAR_BDR_UP       = 5;
const int TRACKBAR_BDR_SIDE     = 5;
const int TRACKBAR_H            = 25;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    g_hwndMain = CreateWindowEx(
            ...
            "The title of my window",
            WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, 800 /*w*/, 640 /*h*/,
